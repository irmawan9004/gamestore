...
export default function Footer() {
  return (
    <section className="footer pt-50">
              ...
              <div className="row gap-sm-0">
                <div className="col-md-4 col-6 mb-lg-0 mb-25">
                  ...
                  <ul className="list-unstyled">
                    <ListFooter list="About Us" />
                    <ListFooter list="Press Release" />
                    <ListFooter list="Terms of Use" />
                    <ListFooter list="Privacy Policy" />
                  </ul>
                </div>
                <div className="col-md-4 col-6 mb-lg-0 mb-25">
                  <TitleFooter title="Support" />
                  <ul className="list-unstyled">
                    <ListFooter list="Refund Policy" />
                    <ListFooter list="Unlock Rewards" />
                    <ListFooter list="Live Chat" />
                    <ListFooter list="Event" />
                  </ul>
                </div>
                <div className="col-md-4 col-12 mt-lg-0 mt-md-0 mt-25">
                  <ul className="list-unstyled">
                    <TitleFooter title="Connect" />
                    <ListFooter list="hi@store.gg" href="mailto: hi@store.gg" />
                    <ListFooter
                      list="team@store.gg"
                      href="mailto: team@store.gg"
                    />
                    <ListFooter
                      list="Pasific 12, Jakarta Selatan"
      ...
      <p className="mt-30 text-lg color-palette-1 mb-40 text-center">
